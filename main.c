...
int Menus()
{
    ...
    printf(" 4. Saya Bingung Pilih Yang Mana Bang.. Keluar Aja Deh! \n");
    printf("######################################################################### \n");
    ...
    case 3 :
        ...
        break;
    case 4 :
        printf("Monggo Enter Aja Gan Kalo Pengen Keluar ^_^");
        break;
    default:
        printf("Kan cuma ada 3 menunya gan ehehe ");
        break;
    }
...
int Increment()
{
    ...
    if (menu == 1) {
        ...
        printf("Menu pengulangan yang agan input tidak kami mudeng :v ???");
    }
...
int CtoF()
{
    ...
    printf("Setelah kami hitung, hasil konversi dari *C ke *F adalah = %f ;)", DerajatF);
    printf("\n----------------------------------------");
